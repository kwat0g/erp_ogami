...
export default function PurchaseRequisitionsPage() {
  ...
  const updateItemRow = (index: number, field: string, value: any) => {
    ...
    if (field === 'quantity' || field === 'estimatedUnitPrice') {
      ...
      const price = field === 'estimatedUnitPrice' ? value : updated[index].estimatedUnitPrice;
      updated[index].estimatedTotalPrice = qty * price;
    }
                          ...
                          <TableRow key={index}>
                            ...
                            <TableCell>
                              <Input
                                ...
                                onChange={(e) => updateItemRow(index, 'estimatedUnitPrice', parseFloat(e.target.value))}
                              />
                            </TableCell>
                            <TableCell>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    {canApprovePR() && <TableHead>Actions</TableHead>}
                  </TableRow>
                </TableHeader>
                <TableBody>
                      ...
                      <TableRow key={pr.id}>
                        ...
                        {canApprovePR() && (
                          <TableCell>
                            ...
                            {pr.status !== 'PENDING' && <span className="text-muted-foreground text-sm">-</span>}
                          </TableCell>
                        )}
                      </TableRow>
                    ))
